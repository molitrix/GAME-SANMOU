...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-300">
    ...
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <section class="mb-12 section">
            ...
            <!-- 军团评比结果 -->
            <section class="mb-12">
                <div class="rounded-xl shadow-lg overflow-hidden" :class="{ 'bg-white': !darkMode, 'bg-gray-800': darkMode }">
                    <div class="p-6">
                        ...
                        <!-- 周总分前三 -->
                        <div class="mb-8">
                            <h3 class="text-lg font-semibold mb-4 border-b pb-2" :class="{'border-gray-200': !darkMode, 'border-gray-700': darkMode}">周总分前三</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <h3 class="text-lg font-semibold mb-3 border-b pb-2" :class="{'border-gray-200': !darkMode, 'border-gray-700': darkMode}">军团特别表彰</h3>
                                <ul class="space-y-2">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold mb-3 border-b pb-2" :class="{'border-gray-200': !darkMode, 'border-gray-700': darkMode}">全员达标军团</h3>
                                <ul class="space-y-2">
                                    <li class="flex items-center">
                ...
                <section class="mb-12">
                    <div class="rounded-xl shadow-lg overflow-hidden" :class="{ 'bg-white': !darkMode, 'bg-gray-800': darkMode }">
                        <div class="p-6">
                            ...
                            <!-- 前三名 -->
                            <div class="mb-8">
                                <h3 class="text-lg font-semibold mb-4 border-b pb-2" :class="{'border-gray-200': !darkMode, 'border-gray-700': darkMode}">榜首</h3>
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <!-- 第一名 -->
                                    <div class="rounded-lg overflow-hidden shadow-lg hover-scale" :class="{'bg-gray-50': !darkMode, 'bg-gray-700': darkMode}">
                            ...
                            <!-- 第4-20名 -->
                            <div>
                                <h3 class="text-lg font-semibold mb-4 border-b pb-2" :class="{'border-gray-200': !darkMode, 'border-gray-700': darkMode}">前茅</h3>
                                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
                                    <div class="p-3 rounded-lg text-center hover:bg-opacity-90 transition-all duration-300" :class="{'bg-gray-200': !darkMode, 'bg-gray-700': darkMode}">
                ...
                <section class="mb-12">
                    <div class="rounded-xl shadow-lg overflow-hidden" :class="{ 'bg-white': !darkMode, 'bg-gray-800': darkMode }">
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <!-- 大杀器 -->
                                <div class="rounded-lg overflow-hidden shadow-md" :class="{'bg-gray-50': !darkMode, 'bg-gray-700': darkMode}">
