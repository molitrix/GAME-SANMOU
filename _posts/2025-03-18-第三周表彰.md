...
<section class="mb-12 section">
    <div class="rounded-xl shadow-lg overflow-hidden bg-white dark:bg-gray-800">
        <div class="p-6">
            <h2 class="text-2xl font-bold mb-6 text-center bg-gradient-to-r from-purple-500 to-indigo-500 bg-clip-text text-transparent">突出贡献奖</h2>
             <h2 class="text-2xl font-bold mb-6 text-center bg-gradient-to-r from-purple-500 to-indigo-500 bg-clip-text text-transparent">（赛季积分榜）</h2>
            <!-- 前三名 -->
            <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="rounded-lg overflow-hidden shadow-md bg-gray-50 dark:bg-gray-700">
                     <div class="p-3 bg-green-600 text-white text-center font-bold flex items-center justify-center">
                                ...
                                <!-- 火场尖兵 -->
                <div class="rounded-lg overflow-hidden shadow-md bg-gray-50 dark:bg-gray-700 md:col-span-2">
                    <div class="p-3 bg-orange-600 text-white text-center font-bold flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="p-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="p-3 rounded-lg bg-gray-100 dark:bg-gray-600">
                                <div class="flex items-center mb-2">
                                    <div class="w-6 h-6 rounded-full bg-yellow-500 flex items-center justify-center mr-2">
                                        <span class="text-white text-xs font-bold">1</span>
                                    </div>
                                    <span class="font-semibold">風雲丨见人跑</span>
                                </div>
                                <div class="space-y-1 pl-8">
                                    <div class="flex justify-between text-sm">
                                        <span>灭火次数:</span>
                                        <span class="font-bold text-orange-500">17次</span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span>火攻伤害:</span>
                                        <span class="font-bold text-orange-500">55万</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-3 rounded-lg bg-gray-100 dark:bg-gray-600">
                                <div class="flex items-center mb-2">
                                    ...
                                    <span class="font-semibold">影丨蓝朋友</span>
                                </div>
                                <div class="space-y-1 pl-8">
                                    <div class="flex justify-between text-sm">
                                        <span>灭火次数:</span>
                                        <span class="font-bold text-orange-500">8次</span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span>火攻伤害:</span>
                                        <span class="font-bold text-orange-500">57万</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-3 rounded-lg bg-gray-100 dark:bg-gray-600">
                                <div class="flex items-center mb-2">
                                    ...
                                    <span class="font-semibold">我来助你丶天</span>
                                </div>
                                <div class="space-y-1 pl-8">
                                    <div class="flex justify-between text-sm">
                                        <span>灭火次数:</span>
                                    ...
                                    <div class="flex justify-between text-sm">
                                        <span>火攻伤害:</span>
                                        <span class="font-bold text-orange-500">28万</span>
                                    </div>
                                </div>
                            </div>
                        </div>
